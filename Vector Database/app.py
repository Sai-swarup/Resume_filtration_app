...
client.recreate_collection(collection_name="test_collection",
        ...
        for page in pdf_reader.pages:
            ...
            for i in range (len(docs)):
                ...
                client.upsert(
                    ...
                    points=[PointStruct(id =id, vector=chunkInfo[i], payload={'pdf':pdf})])
...
def queryupload():
    ...
    taken = time.time() - start
    print("Time taken for query search: {taken: .2f} seconds.")
    return render_template("result.html", result= result)
